...
# End Section
# Section Dip : {43517822-1D23-4AE8-B9A1-6F9082515741}
# 	1:15:IDD_DLG_FEATURE:121
# 	2:16:Resource Include:resource.h
# 	2:14:DlgFeature.cpp:DlgFeature.cpp
# 	2:18:CLASS: CDlgFeature:CDlgFeature
# 	2:15:IDD_DLG_FEATURE:IDD_DLG_FEATURE
# 	2:10:ENUM: enum:enum
# 	2:19:Application Include:dip.h
# 	2:12:DlgFeature.h:DlgFeature.h
# End Section
# Section Dip : {48439016-5DFD-467C-881E-9AECECC85DAF}
# 	1:15:IDD_DLG_Shannon:123
# 	2:16:Resource Include:resource.h
# 	2:12:DlgShannon.h:DlgShannon.h
# 	2:14:DlgShannon.cpp:DlgShannon.cpp
# 	2:15:IDD_DLG_Shannon:IDD_DLG_Shannon
# 	2:18:CLASS: CDlgShannon:CDlgShannon
# 	2:10:ENUM: enum:enum
# 	2:19:Application Include:dip.h
# End Section
...
# 	2:19:Application Include:dip.h
# End Section
# Section Dip : {D8B44367-8DA2-4091-B30B-F3ED7DB5E628}
# 	1:16:IDD_DLG_STRINPUT:124
# 	2:16:Resource Include:resource.h
# 	2:16:IDD_DLG_STRINPUT:IDD_DLG_STRINPUT
# 	2:15:DlgStrInput.cpp:DlgStrInput.cpp
# 	2:10:ENUM: enum:enum
# 	2:19:CLASS: CDlgStrInput:CDlgStrInput
# 	2:19:Application Include:dip.h
# 	2:13:DlgStrInput.h:DlgStrInput.h
# End Section
# Section Dip : {EE31BC10-74AE-4007-A66E-C0DDE9AB568C}
# 	1:15:IDD_DLG_Huffman:122
# 	2:16:Resource Include:resource.h
# 	2:18:CLASS: HuffmanNode:HuffmanNode
# 	2:12:DlgHuffman.h:DlgHuffman.h
# 	2:14:DlgHuffman.cpp:DlgHuffman.cpp
# 	2:10:ENUM: enum:enum
# 	2:18:CLASS: CDlgHuffman:CDlgHuffman
# 	2:15:IDD_DLG_Huffman:IDD_DLG_Huffman
# 	2:20:TYPEDEF: HuffmanNode:HuffmanNode
# 	2:19:Application Include:dip.h
# End Section
...
# 	2:19:Application Include:Dip.h
# End Section
# Section Dip : {B7364AB2-0173-40EB-9BB4-A9F55B79F020}
# 	2:15:CLASS: CRestore:CRestore
# 	2:9:Restore.h:Restore.h
# 	2:19:Application Include:dip.h
# 	2:11:Restore.cpp:Restore.cpp
# End Section
...
# 	2:19:Application Include:dip.h
# End Section
# Section Dip : {87B620D1-A7E9-4A20-9C62-7603DA9E20D0}
# 	2:14:ImgAnalyse.cpp:ImgAnalyse1.cpp
# 	2:18:CLASS: LabelResult:LabelResult
# 	2:16:CLASS: EdgePoint:EdgePoint
# 	2:18:CLASS: CImgAnalyse:CImgAnalyse
# 	2:19:Application Include:dip.h
# 	2:12:ImgAnalyse.h:ImgAnalyse1.h
# End Section
